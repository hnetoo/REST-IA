-- Migration: Fix Dashboard Chart Data - Final Version
-- Description: Add chartData with date grouping (no nested aggregates)
-- Created: 2026-03-13 18:36:56

-- 1. Atualizar função get_dashboard_metrics para incluir chartData
