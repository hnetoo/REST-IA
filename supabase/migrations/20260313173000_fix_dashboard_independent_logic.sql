-- Migration: Fix Dashboard Independent Logic - Separate Global from Temporal Data
-- Description: Rewrite get_dashboard_metrics with independent calculation blocks
-- Created: 2026-03-13 17:30:00

-- 1. Recriar função get_dashboard_metrics com blocos independentes
...
BEGIN
  ...
  -- Calcular dados temporais do período
  SELECT 
