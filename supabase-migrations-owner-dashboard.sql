-- MIGRAÇÃO SUPABASE - OWNER DASHBOARD
-- Estrutura de tabelas para alimentar o Dashboard com dados reais
-- Criação: 13/03/2026
-- Objetivo: Suportar cards de faturação, despesas e impostos
...
-- 6. DADOS DE EXEMPLO (apenas para desenvolvimento)
INSERT INTO business_stats (legacy_revenue_kz, description, period_start, period_end) VALUES
(150000.00, 'Faturação histórica - Sistema antigo', '2026-01-01', '2026-01-31'),
(125000.00, 'Faturação histórica - Sistema antigo', '2026-02-01', '2026-02-28')
ON CONFLICT DO NOTHING;

INSERT INTO expenses (description, amount_kz, category, is_recurring) VALUES
('Salário Cozinheiro Chefe', 80000.00, 'staff', TRUE),
('Salário Garçons', 60000.00, 'staff', TRUE),
('Renda do Estabelecimento', 45000.00, 'rent', TRUE),
('Eletricidade', 15000.00, 'utilities', TRUE),
('Água e Gás', 8000.00, 'utilities', TRUE),
('Material de Limpeza', 5000.00, 'supplies', FALSE)
ON CONFLICT DO NOTHING;
...
-- 9. VIEW PARA CONSULTA SIMPLIFICADA
