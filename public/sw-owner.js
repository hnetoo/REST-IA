...
const CACHE_NAME = 'owner-dashboard-v5';
const STATIC_ASSETS = [
  '/owner.html',
  '/manifest-owner.json',
  '/icon.png',
...
// Estratégia de Cache: apenas para owner.html e seus assets específicos
self.addEventListener('fetch', (event) => {
  ...
  // Ignorar tudo que não seja owner.html ou seus assets específicos
  if (!STATIC_ASSETS.includes(url.pathname) && url.pathname !== '/owner.html') {
    return;
  }
  
  // Cache First apenas para owner.html e assets do PWA owner
  event.respondWith(
