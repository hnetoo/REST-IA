        ...
        <div className="mb-8 p-6 bg-white/5 rounded-xl border border-white/10">
          ...
          {isSyncing && (
            <div className="w-full bg-white/10 rounded-full h-2 overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-[#06b6d4] to-[#0891b2] transition-all duration-300 ease-out w-var-progress"
                style={{'--progress-width': `${syncProgress}%`} as React.CSSProperties}
              ></div>
            </div>
          )}
                      ...
                      {(() => {
                        ...
                        return stableImageUrl ? (
                          <>
                            ...
                            />
                            <div className="w-full h-full bg-slate-700 flex items-center justify-center hidden">
