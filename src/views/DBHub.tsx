...
import { databaseService, BackupFile, DatabaseLog } from '../lib/database/databaseService';
import { 
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-8">
          <div className="max-w-md w-full glass-panel p-10 rounded-[3rem] border border-white/10 text-center space-y-8 animate-in zoom-in duration-300">
            ...
            <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
              <div 
                className="h-full bg-primary transition-all duration-300 shadow-glow w-0" 
