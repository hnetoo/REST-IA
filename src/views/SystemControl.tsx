            ...
            <div className="lg:col-span-2 glass-panel p-10 rounded-[3rem] border-white/5 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                 <div className="space-y-4">
                    ...
                    <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full bg-primary shadow-glow transition-all duration-1000 w-0" ref={(el) => { if (el) el.style.width = `${cpuLoad}%`; }}></div>
                    </div>
                 </div>
                 <div className="space-y-4">
                    <div className="flex justify-between text-[10px] font-black uppercase text-slate-500">
                    ...
                    <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full bg-emerald-500 shadow-glow w-full"></div>
                    </div>
                 </div>
              </div>
              <div className="mt-12 p-6 bg-black/40 rounded-3xl border border-white/5">
                 ...
                 <div className="space-y-2 text-[10px] text-slate-600 font-mono">
                    <p><span className="text-primary">[OK]</span> Core v1.1.2: Active</p>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="glass-panel p-10 rounded-[3rem] border-red-500/30 bg-red-500/5">
               ...
               <div className="space-y-6 bg-black/40 p-8 rounded-[2.5rem] border border-red-500/20">
                  <input type="text" className="w-full p-5 bg-red-500/10 border border-red-500/20 rounded-2xl text-center text-white font-black tracking-[0.5em] outline-none" value={confirmText} onChange={e => setConfirmText(e.target.value)} aria-label="Confirmação de produção - escreva PRODUCAO" />
