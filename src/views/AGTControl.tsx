                ...
                <div className="space-y-6">
                   <div>
                      ...
                      <input 
                        ...
                        placeholder="Capital social em AOA"
                      />
                   </div>
                   <div>
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input 
                          readOnly
                          className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl text-white/50 outline-none font-mono text-sm cursor-not-allowed" 
          ...
          <div className="glass-panel rounded-[3.5rem] border border-white/5 overflow-hidden">
             <div className="p-10 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                ...
                <div className="flex gap-2">
                   <button className="p-4 bg-white/5 rounded-2xl text-slate-400 hover:text-white transition-all" aria-label="Imprimir log de auditoria"><Printer size={20}/></button>
                </div>
             </div>
             <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white/5">
                   {activeOrders.filter(o => o.status === 'closed' || o.status === 'FECHADO').slice(-12).map(order => (
                     <tr key={order.id} className="hover:bg-white/5 transition-colors group">
                        ...
                        <td className="px-10 py-6 text-right">
                           <button className="p-3 text-slate-500 hover:text-white transition-colors" aria-label="Imprimir documento"><Printer size={16}/></button>
                        </td>
                     </tr>
                   ))}
                   {activeOrders.filter(o => o.status === 'closed' || o.status === 'FECHADO').length === 0 && (
                     <tr>
