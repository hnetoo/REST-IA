  ...
  return (
    <div className="p-8 h-full overflow-y-auto no-scrollbar bg-background text-slate-200">
      ...
      <div className="glass-panel rounded-[3rem] p-10 min-h-[500px] border border-white/5 relative animate-in fade-in duration-500">
        ...
        {activeTab === 'GENERAL' && (
          <div>
            <form onSubmit={handleSaveSettings} className="max-w-3xl space-y-10 max-h-[calc(100vh-180px)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-transparent">
        ...
        {activeTab === 'SUPABASE' && (
          <div className="space-y-12 max-h-[calc(100vh-180px)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-transparent">
            {/* Header de Conexão */}
        ...
        {activeTab === 'OPERATORS' && (
          <div className="space-y-8 max-h-[calc(100vh-180px)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-transparent">
