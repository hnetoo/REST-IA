...
type ExpenseCategory = 'ALIMENTACAO' | 'BEBIDAS' | 'MATERIAL_LIMPEZA' | 'UTILIDADES' | 'REPARACOES' | 'MARKETING' | 'OUTROS';
type ExpenseStatus = 'PENDENTE' | 'APROVADO' | 'PAGO';
...
const Finance = () => {
  ...
  const handleAddExpense = async () => {
    if (!newExpense.description || newExpense.amount_kz <= 0 || !newExpense.category) {
  ...
  const handleUpdateExpense = () => {
    if (!editingExpense || !newExpense.description || newExpense.amount_kz <= 0) {
