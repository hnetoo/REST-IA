  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 p-6 font-mono text-xs">
      ...
      <form onSubmit={handleCommand} className="relative">
        ...
        />
        <button type="submit" title="Enviar comando" aria-label="Enviar comando" className="absolute right-2 top-1/2 -translate-y-1/2 text-primary hover:scale-110 transition-transform">
          <Send size={18} />
        </button>
      </form>
    </div>
